				...
				if (resp.status == 202) {
					...
					$.each(resp.message, function(index, value){
						adminHTML += '<tr>'+
                                        ...
                                        '<td>'+ value.cnic +'</td>'+
										'<td><a class="btn btn-sm btn-info edit-Clerk"><span style="display:none;">'+JSON.stringify(value)+'</span><i class=" glyphicon glyphicon-pencil"></i></a>&nbsp;<a cid="'+value.id+'" class="btn btn-sm btn-danger delete-Clerk"><i class=" glyphicon glyphicon-trash"></i></a></td>'+
									'</tr>';
					});
