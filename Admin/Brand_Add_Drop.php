         ...
         <!------------Navigation Left side bar --------->
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <h3 class="panel-title"><a href="javascript:void(0);" class="toggle-sidebar"><span class="fa fa-angle-double-left" data-toggle="offcanvas" title="Maximize Panel"></span></a>Manage Brand</h3>
              </div>
			...
			success : function(response){
				...
				$.each(resp.message, function(index, value){
					brandHTML += '<tr>'+
									...
									'<td><a class="btn btn-sm btn-info edit-brand"><span style="display:none;">'+JSON.stringify(value)+'</span><i class=" glyphicon glyphicon-pencil"></i></a>&nbsp;<a bid="'+value.brand_id+'" class="btn btn-sm btn-danger delete-brand"><i class=" glyphicon glyphicon-trash"></i></a></td>'+
