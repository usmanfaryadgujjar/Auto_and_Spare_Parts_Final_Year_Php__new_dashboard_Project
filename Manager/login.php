...
<div class="container ">
	<div class="row justify-content-center" style="margin:100px 0;">
      ...
      <div class="column">
        <img class="circular--square" src="" alt="" />
			...
			<h2 class="row justify-content-center"><b>Manager Login</b></h2>
    ...
    <div class="container">
       ...
       <button  class="btn btn-outline-primary" style="float:left; margin-left:50px;">Only Seller Login Click Here</button>
       </a>
            -------->
